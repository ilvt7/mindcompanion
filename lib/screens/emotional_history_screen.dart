...
class _EmotionalHistoryScreenState extends State<EmotionalHistoryScreen>
  ...
  List<DiaryEntry> get _filteredEntries {
    ...
    return _allEntries.where((entry) => entry.emotion == _selectedFilter).toList();
  }
                          ...
                          children: [
                            ...
                            Wrap(
                              ...
                              children: _availableEmotions.map((emotion) {
                                ...
                                return _buildFilterChip(emotion, _selectedFilter == emotion, chipColor);
                              }).toList(),
                            ),
                          ],
                        ),
                          ...
                          children: [
                            ...
                            TableCalendar<DiaryEntry>(
                              ...
                              calendarStyle: CalendarStyle(
                                ...
                                weekendTextStyle: const TextStyle(color: Color(0xFFF56565)),
                                holidayTextStyle: const TextStyle(color: Color(0xFFF56565)),
                              ...
                              calendarBuilders: CalendarBuilders(
                                markerBuilder: (context, date, events) {
                                  ...
                                  return Positioned(
                                    ...
                                    child: Row(
                                      mainAxisSize: MainAxisSize.min,
                                      children: _getEventMarkers(date, events),
                                    ),
                                  );
                                },
                              ),
                                    ...
                                    Expanded(
                                      child: LineChart(
                                        LineChartData(
                                            ...
                                            leftTitles: AxisTitles(
                                              sideTitles: SideTitles(
                                                ...
                                                getTitlesWidget: (value, meta) {
                                                  ...
                                                  if (value == 1.5) return const Text('😢', style: TextStyle(fontSize: 12));
                                                  if (value == 2.5) return const Text('😐', style: TextStyle(fontSize: 12));
                                                  if (value == 4.0) return const Text('😌', style: TextStyle(fontSize: 12));
                                                  if (value == 5.0) return const Text('😊', style: TextStyle(fontSize: 12));
                                                  return const Text('');
                                                },
                                              ),
                                            ),
                                          ...
                                          minX: 0,
                                          maxX: (_allEntries.length - 1).toDouble().clamp(0, 20),
                                          minY: 0,
                                          maxY: 5,
                                          lineBarsData: [
                                            LineChartBarData(
                            ...
                            Row(
                              ...
                              children: [
                                _buildLegendItem('😠 Negative', const Color(0xFFF56565)),
                                _buildLegendItem('😐 Neutral', const Color(0xFF718096)),
                                _buildLegendItem('😊 Positive', const Color(0xFF48BB78)),
                              ],
                            ),
                          ],
                        ),
