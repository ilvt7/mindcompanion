...
class MeditationTransitionConfig {
  ...
  static const Duration meditationTransitionDuration = Duration(
    milliseconds: 1000,
  );
  ...
  static const double depthScaleFactor = 0.97;
...
class MeditationZoomEffectsConfig {
  ...
  // Configuración de meditación scale
  static const double meditationScaleStart = 0.95;
  static const double meditationScaleEnd = 1.0;
}
...
class MeditationElementTransitionConfig {
  ...
  static const Duration meditationCardSlideDuration = Duration(
    milliseconds: 400,
  );
