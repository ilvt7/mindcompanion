...
void main() {
  group('Crisis Mode Screen Golden Tests', () {
    testWidgets('Crisis Mode screen matches golden file', (WidgetTester tester) async {
      ...
      await expectLater(
        find.byType(CrisisModeScreen),
        matchesGoldenFile('test/golden/crisis_mode_screen.png'),
      );
    });
  });
}
...
5. To update only specific golden files:
   flutter test test/golden/crisis_mode_screen_golden_test.dart --update-goldens
