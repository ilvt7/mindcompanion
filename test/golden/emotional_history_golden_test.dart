...
void main() {
  group('Emotional History Screen Golden Tests', () {
    testWidgets('Emotional History screen matches golden file', (
      ...
      await expectLater(
        find.byType(EmotionalHistoryScreen),
        matchesGoldenFile('test/golden/emotional_history_screen.png'),
      );
    });
  });
}
...
5. To update only specific golden files:
   flutter test test/golden/emotional_history_golden_test.dart --update-goldens
