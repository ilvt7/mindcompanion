...
import 'package:mindcompanion/screens/privacy_policy_screen.dart';
  ...
  group('Privacy Policy Screen Golden Tests', () {
    testWidgets('Privacy Policy screen matches golden file', (
      ...
      await expectLater(
        ...
        matchesGoldenFile('test/golden/privacy_policy_screen.png'),
      );
    });
  });
}
...
5. To update only specific golden files:
   flutter test test/golden/privacy_policy_screen_golden_test.dart --update-goldens
