...
void main() {
  group('Personal Diary Screen Golden Tests', () {
    testWidgets('Personal Diary screen matches golden file', (WidgetTester tester) async {
      ...
      await expectLater(
        find.byType(PersonalDiaryScreen),
        matchesGoldenFile('test/golden/personal_diary_screen.png'),
      );
    });
  });
}
...
5. To update only specific golden files:
   flutter test test/golden/personal_diary_screen_golden_test.dart --update-goldens
