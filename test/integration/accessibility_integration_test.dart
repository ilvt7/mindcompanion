...
void main() {
  group('Accessibility Integration Tests', () {
    testWidgets('should display all accessibility settings correctly', (WidgetTester tester) async {
    ...
    testWidgets('should toggle high contrast and apply changes', (WidgetTester tester) async {
      await TestHelpers.pumpAppWithProviders(
        tester,
        const SettingsScreen(),
      );
    ...
    testWidgets('should toggle reduced motion and apply changes', (WidgetTester tester) async {
      await TestHelpers.pumpAppWithProviders(
        tester,
        const SettingsScreen(),
      );
    ...
    testWidgets('should adjust text scale and apply changes', (WidgetTester tester) async {
      await TestHelpers.pumpAppWithProviders(
        tester,
        const SettingsScreen(),
      );
    ...
    testWidgets('should persist accessibility settings', (WidgetTester tester) async {
      ...
      final reducedMotionWidget = tester.widget<Switch>(reducedMotionSwitchAfter);
      
      expect(highContrastWidget.value, true);
      expect(reducedMotionWidget.value, true);
    });

    testWidgets('should apply text scaling globally', (WidgetTester tester) async {
      await TestHelpers.pumpAppWithProviders(
        tester,
        const WelcomeScreen(),
      );
    ...
    testWidgets('should apply high contrast theme globally', (WidgetTester tester) async {
      await TestHelpers.pumpAppWithProviders(
        tester,
        const WelcomeScreen(),
      );
    ...
    testWidgets('should show semantic labels for screen readers', (WidgetTester tester) async {
      await TestHelpers.pumpAppWithProviders(
        tester,
        const SettingsScreen(),
      );
    ...
    testWidgets('should reset accessibility settings to defaults', (WidgetTester tester) async {
      await TestHelpers.pumpAppWithProviders(
        tester,
        const SettingsScreen(),
      );
