...
void main() {
  ...
  group('Golden Integration Tests', () {
    testWidgets('Capture golden screenshots during user journey', (
      WidgetTester tester,
    ) async {
      // Start the app
      app.main();
    ...
    testWidgets('Capture crisis mode golden screenshots', (
      WidgetTester tester,
    ) async {
      // Start the app
      app.main();
    ...
    testWidgets('Capture meditation golden screenshots', (
      WidgetTester tester,
    ) async {
      // Start the app
      app.main();
