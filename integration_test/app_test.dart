...
void main() {
  ...
  group('MindCompanion User Journey Tests', () {
    testWidgets('Complete user journey: Welcome → Home → AI Diary → Personal Diary → History', (WidgetTester tester) async {
      // Start the app
      app.main();
    ...
    testWidgets('Crisis Mode Journey: Home → Crisis Mode → Emergency Contacts', (WidgetTester tester) async {
      // Start the app
      app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('Meditation Journey: Home → Meditation → Audio Playback', (WidgetTester tester) async {
      // Start the app
      app.main();
      await tester.pumpAndSettle();
...
Future<void> _testWelcomeScreen(WidgetTester tester) async {
  ...
  expect(find.text('Your AI-powered mental wellness companion'), findsOneWidget);
...
Future<void> _testPersonalDiaryScreen(WidgetTester tester) async {
  ...
  final textField = find.byType(TextField);
  if (textField.evaluate().isNotEmpty) {
    await tester.enterText(textField.first, 'This is my personal reflection...');
    await tester.pumpAndSettle();
